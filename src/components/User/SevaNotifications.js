        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={styles.container}>
                    <View style={{ marginTop: 30, width: "100%", backgroundColor: "#F8E9C8", flex: 1, flexDirection: "column", alignItems: "center" }}>
                        ...
                        <View style={{ flex: 0, alignItems: "start", justifyContent: "center", width: "95%", height: 50, backgroundColor: "white", borderRadius: 10, margin: 10 }}>
